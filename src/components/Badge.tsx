...
const badgeVariants = cva(
  "inline-flex items-center justify-center gap-1 border font-medium whitespace-nowrap text-white transition-colors",
  {
    ...
    compoundVariants: [
      ...
      { variant: "success", fill: true, class: "border-emerald-500 bg-emerald-500 text-white" },
      { variant: "warning", fill: true, class: "border-amber-500 bg-amber-500 text-white" },
      { variant: "danger", fill: true, class: "border-red-500 bg-red-500 text-white" },
      {
        variant: "outline",
        fill: true,

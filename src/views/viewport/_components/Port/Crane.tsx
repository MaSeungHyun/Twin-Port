import craneUrl from "@/assets/model/crane.glb";
...
type CraneProps = {
  instances: CraneInstance[];
};

export default function Crane({ instances }: CraneProps) {
  const { scene } = useGLTF(craneUrl);

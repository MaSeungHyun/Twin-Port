 ...
 */
export const OCEAN_POSITION_Y = -0.3;
/**
 * 수면 메시 가로·세로 분할 수.
...
export const OCEAN_HEIGHT_SCALE = 4.2;
...
/** 선체 길이의 절반 (월드, SHIP_SCALE=1 기준). 물이 밀리는 선수~선미 범위 */
export const OCEAN_HULL_HALF_LEN = 6.8;
/** 선체 폭의 절반. 물이 밀리는 좌우 범위 */
export const OCEAN_HULL_HALF_WIDTH = 0.55;
